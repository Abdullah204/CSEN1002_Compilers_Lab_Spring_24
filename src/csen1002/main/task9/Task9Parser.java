// Generated from Task9.g4 by ANTLR 4.13.1
...
public class Task9Parser extends Parser {
	...
	public static final int T__0 = 1, T__1 = 2, T__2 = 3, WS = 4;
	public static final int RULE_s = 0, RULE_f = 1, RULE_d = 2, RULE_t = 3, RULE_n = 4;
	...
	public static class SContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof Task9Listener)
				((Task9Listener) listener).enterS(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof Task9Listener)
				((Task9Listener) listener).exitS(this);
		}
	}
	...
	public static class FContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof Task9Listener)
				((Task9Listener) listener).enterF(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof Task9Listener)
				((Task9Listener) listener).exitF(this);
		}
	}
	...
	public static class DContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof Task9Listener)
				((Task9Listener) listener).enterD(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof Task9Listener)
				((Task9Listener) listener).exitD(this);
		}
	}
		...
		try {
			...
			switch (getInterpreter().adaptivePredict(_input, 1, _ctx)) {
				case 1:
					...
					((DContext) _localctx).l = ((DContext) _localctx).e1.l;
					((DContext) _localctx).check = (1 - equals(_localctx.c, _localctx.r))
							* ((DContext) _localctx).e1.check;
				...
				case 2:
					...
					((DContext) _localctx).l = ((DContext) _localctx).e1.l;
					((DContext) _localctx).check = equals(_localctx.c, _localctx.r) * ((DContext) _localctx).e1.check;
				...
				case 3:
					...
					setState(30);
					match(T__0);
					((DContext) _localctx).l = _localctx.c;
					((DContext) _localctx).check = 1 - equals(_localctx.c, _localctx.r);
				}
					break;
				case 4:
					...
					match(T__1);
					((DContext) _localctx).l = _localctx.c;
					((DContext) _localctx).check = equals(_localctx.c, _localctx.r);
				}
					break;
			}
		} catch (RecognitionException re) {
	...
	public static class TContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof Task9Listener)
				((Task9Listener) listener).enterT(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof Task9Listener)
				((Task9Listener) listener).exitT(this);
		}
	}
	...
	public final TContext t(int l, int r) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				((TContext) _localctx).check = ((TContext) _localctx).n.check;
				((TContext) _localctx).m = ((TContext) _localctx).n.m;
			}
		} catch (RecognitionException re) {
			_localctx.exception = re;
			_errHandler.reportError(this, re);
	...
	public static class NContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if (listener instanceof Task9Listener)
				((Task9Listener) listener).enterN(this);
		}

		@Override
		public void exitRule(ParseTreeListener listener) {
			if (listener instanceof Task9Listener)
				((Task9Listener) listener).exitN(this);
		}
	}
